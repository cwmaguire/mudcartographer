...
public class DefaultDescriptionPanel extends RoomDescriptionPanel {
    ...
    public DefaultDescriptionPanel() {
    }
    ...
    private void addActionListeners() {
        ...
        editButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                DefaultDescriptionPanel.this.setEnabled(!DefaultDescriptionPanel.this.getEnabled());
                if (!DefaultDescriptionPanel.this.getEnabled()) {
                    room.setDescription(roomDescriptionTextArea.getText());
                    controller.fireRoomEvent(new RoomEvent(room, ROOM_PROPERTIES, DefaultDescriptionPanel.this));
                } else {

 ...
 * NOT THREAD SAFE
 */
public class AMRoomInfoPanel extends RoomInfoPanel implements RoomEventListener {
    ...
    private void addActionListeners(){
        ...
        roomSymbolField.addKeyListener(new KeyAdapter(){
            public void keyTyped(KeyEvent e){
                ...
                controller.fireRoomEvent(new RoomEvent(room, Room.RoomProperty.SYMBOL.getFlag(), AMRoomInfoPanel.this));
            }
        });

        textColorButton.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e){
                Color newColor = JColorChooser.showDialog(AMRoomInfoPanel.this, "Choose text Color", textColorButton.getBackground());
                if(newColor != null){
                    textColorButton.setBackground(newColor);
                    room.setTextColor(newColor);
                    controller.fireRoomEvent(new RoomEvent(room, Room.RoomProperty.TEXT_COLOR.getFlag(), AMRoomInfoPanel.this));
                }
            }
        });
        ...
        backgroundColorButton.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e){
                Color newColor = JColorChooser.showDialog(AMRoomInfoPanel.this, "Choose text Color", backgroundColorButton.getBackground());
                if(newColor != null){
                    backgroundColorButton.setBackground(newColor);
                    room.setBackgroundColor(newColor);
                    controller.fireRoomEvent(new RoomEvent(room, Room.RoomProperty.BACKGROUND_COLOR.getFlag(), AMRoomInfoPanel.this));
                }
            }
        });
    }
